...
append d/nodes make-node [id: 1  type: 'const    name: "const_A"    label: "Const A"    x: 0    y: 0]
append d/nodes make-node [id: 2  type: 'add      name: "add_1"      label: "Add"        x: 200  y: 0]
append d/nodes make-node [id: 3  type: 'display  name: "display_1"  label: "Display"    x: 400  y: 0]
...
append d2/nodes make-node [id: 1  type: 'const    name: "cA"  label: "A"  x: 0    y: 0]
append d2/nodes make-node [id: 2  type: 'const    name: "cB"  label: "B"  x: 0    y: 60]
append d2/nodes make-node [id: 3  type: 'add      name: "s1"  label: "S"  x: 200  y: 30]
append d2/nodes make-node [id: 4  type: 'display  name: "d1"  label: "D"  x: 400  y: 30]
...
append d4/nodes make-node [id: 1  type: 'const  name: "solo"  label: "Solo"  x: 0  y: 0]
...
append d5/nodes make-node [id: 10  type: 'add  name: "x1"  label: "X"  x: 0    y: 0]
append d5/nodes make-node [id: 11  type: 'add  name: "y1"  label: "Y"  x: 200  y: 0]
